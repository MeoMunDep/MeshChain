...
cls
echo =================================================================
echo    Meshchain BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios meo-forkcy-colors meo-forkcy-utils https-proxy-agent socks-proxy-agent crypto-js ws uuid xlsx readline-sync
    cd %~dp0
) else (
